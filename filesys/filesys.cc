    ...
    if (format)
        {
            ...
            mapHdr->SetCreatedTime();
            mapHdr->UpdateLastUsedTime();
            mapHdr->UpdateLastModifiedTime();
            dirHdr->SetCreatedTime();
            dirHdr->UpdateLastUsedTime();
            dirHdr->UpdateLastModifiedTime();
